...
{% hint style="success" %}
Make sure that you have installed [`react-native-plaid-link-sdk`](../../integration-guides/react-native/installation.md)
{% endhint %}
...
Provide your Android Package Name to the [`RatioComponent`](../../integration-guides/react-native/session-token-and-wallet-signing.md)
