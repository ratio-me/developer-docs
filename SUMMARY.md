...
* [React Native](integration-methods/react-native/README.md)
  ...
  * [Configure Plaid](integration-methods/react-native/configure-plaid.md)
  * [Session and Client Auth](integration-methods/react-native/session-and-client-auth.md)
...
* [API](reference/api/README.md)
  * [💱 Activity](reference/api/activity.md)
  * [🔐 Auth](reference/api/auth/README.md)
    * [🪙 Crypto Wallet](reference/api/auth/crypto-wallet.md)
    * [📩 Email OTP](reference/api/auth/email-otp.md)
    * [📲 SMS OTP](reference/api/auth/sms-otp.md)
  * [🏦 Bank](reference/api/bank.md)
  * [🤝 Client](reference/api/client.md)
  * [💲 Crypto](reference/api/crypto.md)
